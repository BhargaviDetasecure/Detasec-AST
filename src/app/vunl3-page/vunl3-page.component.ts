...
@Component({
  selector: 'app-vunl3-page',
  templateUrl: './vunl3-page.component.html',
  styleUrls: ['./vunl3-page.component.css']
})
export class Vunl3PageComponent implements OnInit {
  isPage1 = true;
  isPage4 = false;
  ...
  ngOnInit(): void {
    if(localStorage.getItem('isAnswerShown2')){
  ...
  isShowAnswerOnClick(){
    this.showDetailedAnswer = true;
    localStorage.setItem('isAnswerShown2', 'true');
  }
